<template>
  ...
  <b-row class="mt-4 mb-4 text-center">
      ...
      <b-col>
        <button class="likeBtn" @click="registInterestArea(dongCode,userInfo.userId)">관심 지역 등록</button>
      </b-col>
      <b-col class="tag">
      ...
      <b-col>
        ...
        <div v-else><span>{{userInfo.userName}}님</span> <span class="bar-item" @click="logout">로그아웃</span></div>
      </b-col>
    </b-row>
    </nav>
  </header>
...
data() {
  ...
  computed: {
    name:"HeaderNavbar",
    ...mapState(houseStore, ["sidos", "guguns", "dongs","houses","points","cnts","building"]),
