...
또한 학생들 직장인들을 위해 매물 중심으로 맛집, 놀거리, 편의시설 상가를 검색해서 보여준다. 이를 바탕으로 사용자의 취향에 맞는 매물을 선택할 수 있도록 도와준다. 또한 매물의 최근 10개의 거래를 보여주므로써 사용자가 분석하여 매물을 선택할 수 있도록 도와주는 서비스를 제공한다.
...
추가로 사용자가 관심 지역과 관심 매물을 선택하면 따로 저장하여 바로 정보를 확인할 수 있도록 도와준다.
...
## 화면설계도
[화면설계도](https://github.com/PMH2906/Algorithm_Study/files/10227594/default.pdf)

## 보고서 
[보고서](https://github.com/PMH2906/Algorithm_Study/files/10227638/Marketing.Plan.for.Realtors.by.Slidesgo.pdf)
